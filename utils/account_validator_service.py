                ...
                try:
                    ...
                    for i, account in enumerate(user_accounts):
                        try:
                            ...
                            logger.info(f"Проверка аккаунта {i+1}/{len(user_accounts)}: @{account.username} (пользователь {user_id})")
                    ...
                    logger.info(f"✅ Пользователь {user_id}: {user_processed_accounts} аккаунтов проверено")
